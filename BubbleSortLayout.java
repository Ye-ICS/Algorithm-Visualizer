...
class BubbleSortLayout extends BorderPane {
    ...
    private void initializeBars(int count) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            final int index = i;
            bar.setOnMouseClicked(event -> selectBar(index));
        ...
        // Add selection highlight rectangle
        barsContainer.getChildren().add(selectedBarHighlight);
        selectedBarIndex = -1;
        selectedBarHighlight.setVisible(false);
    ...
    private void selectBar(int index) {
        ...
        Rectangle selectedBar = bars.get(index);
    ...
    private void applyCustomValue() {
        ...
        try {
            ...
            selectedBarHighlight.setY(bar.getY() - 2);
            selectedBarHighlight.setHeight(bar.getHeight() + 4);
